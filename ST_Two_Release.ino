...
//
// Brief:
// Sketch used in the Solder: Time II Watch Kit, more info and build
// instructions at http://www.spikenzielabs.com/st2
//
//
// LEGAL:
...
// 1. Moved Time and Date request during time and date display to top
//      of Display Time routine.
// 2. Reduced frequency that the Time and Date is requested from the RTC
//      (once every 2000 loops).
//
// Improved brightness consistancy on all columns.
// 1. Added delay to "on time" of all the pixels in the first 16 columns
//      that are driven by the Demultiplexer.
// 2. Adjusted delays to for Scrolling Text and Worm animation to balance
//      slower overall refresh from added brightness delay.
//
// Fixed bug introduced by Arduino 1.0.1
// 1. Added conditional compile in Setup for the button pins. Arduino >
//      1.0 uses INPUT_PULLUP vs Digitalwrite HIGH.
//
